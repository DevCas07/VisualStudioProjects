...
namespace LineDrawerDemo
{
    public partial class MainWindow : Form
    {
        ...
        public class LineHandling
        {
            ...
            // Line Dictionary ------------------------------------------
            //
            public Dictionary<int, LineObject> LineObjects;
            public LineHandling()
            {
                Dictionary<int, LineObject> LineObjects = new Dictionary<int, LineObject>(); 
            }
            ...
            /// <param name="x2"></param>
            /// <param name="y2"></param>
            public void editLineProperties(int key, int x1 = -1, int y1 = -1, int x2 = -1, int y2 = -1) //Edits a specific line's coordinates, --fixes it's x and y coordinates--, updates the TreeView
            {
        ...
        public class CanvasHandling
        {
            ...
            public LineHandling lineHandle = new LineHandling();
        ...
        class FileHandling : CanvasHandling
        {
        ...
        //public LineHandling lineHandleing = new LineHandling();
